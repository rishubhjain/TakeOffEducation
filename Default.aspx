        ...
        <div class="container">
            <div class="row">
                <div class="12u">
                    ...
                    <header id="header">
                        <h1><a href="#" id="logo">Take Off Education</a></h1>
                        <nav id="nav">
                            <a href="index.html" class="current-page-item">Home</a>
                            <a href="twocolumn1.html">Profile</a>
                            <a href="twocolumn2.html">Inquiry</a>
                            <a href="onecolumn.html">Contact</a>
                            <a href="threecolumn.html">SiteMap</a>
                        </nav>
                    </header>
            ...
            <div class="row main-row">
                <div class="4u">
                    ...
                    <section>
                        ...
                        <p>
                            This is <strong>Minimaxing</strong>, a fully responsive HTML5 site template designed by <a href="http://n33.co">n33</a> and released for free by <a href="http://html5up.net">HTML5 UP</a>. It features
							a simple, lightweight design, solid HTML5 and CSS3 code, and full responsive support for desktop, tablet, and mobile displays.
                        </p>
                ...
                <div class="4u">
                    ...
                    <section>
                        ...
                        <ul class="small-image-list">
                            ...
                            <li>
                                <a href="#">
                                    <img src="images/pic1.jpg" alt="" class="left" /></a>
                                <h4>James Doe</h4>
            ...
            <div class="row main-row">
                <div class="6u">
                    ...
                    <section>
                        ...
                        <ul class="big-image-list">
                            <li>
                                <a href="#">
                                    <img src="images/pic3.jpg" alt="" class="left" /></a>
                                <h3>Magna Gravida Dolore</h3>
                                <p>
                                    Varius nibh. Suspendisse vitae magna eget et amet mollis justo 
                            ...
                            <li>
                                <a href="#">
                                    <img src="images/pic4.jpg" alt="" class="left" /></a>
                                <h3>Magna Gravida Dolore</h3>
                                <p>
                                    Varius nibh. Suspendisse vitae magna eget et amet mollis justo 
									facilisis amet quis consectetur in, sollicitudin vitae justo. Cras 
                            ...
                            <li>
                                <a href="#">
                                    <img src="images/pic5.jpg" alt="" class="left" /></a>
                                <h3>Magna Gravida Dolore</h3>
                                <p>
                                    Varius nibh. Suspendisse vitae magna eget et amet mollis justo 
									facilisis amet quis consectetur in, sollicitudin vitae justo. Cras 
                ...
                <div class="6u">
                    ...
                    <article class="blog-post">
                        ...
                        <a href="#">
                            <img src="images/pic6.jpg" alt="" class="top blog-post-image" /></a>
                        <h3>Magna Gravida Dolore</h3>
                        <p>
